...
public class ConfigUsuarioActivity extends AppCompatActivity {
    ...
    private EditText edtNome, edtEndereco;
    ...
    private void recuperaDados() {
        DatabaseReference empRef = firebaseRef.child("usuarios").child(idUsuario);
        empRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()) {
                    ...
                    Picasso.get().load(usuario.getUrlImagem()).into(imgUsuario);
                }
    ...
    private boolean validaDados() {
        ...
        return !nome.isEmpty() && !endereco.isEmpty();
    }
            ...
            Task<Uri> urlTask = uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()) {
                        ...
                        usuario = new Usuario();
                        usuario.setUrlImagem(downloadUrl.toString());
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if (requestCode == 2 && resultCode == Activity.RESULT_OK && data != null) {
            ...
            try {
                ...
                imgUsuario.setImageBitmap(bitmapImage);
            } catch (Exception e) {
                e.printStackTrace();
            }
        }
